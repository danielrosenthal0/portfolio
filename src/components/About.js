        ...
        <Fragment>
            <div className={styles.content}>
                ...
                <div className={styles.about}>
                    <p>My name is Daniel Rosenthal and I am from Yardley, Pennsylvania
                     ...
                     I am majoring in engineering with a concentration in computer and electrical engineering.
                      I am also minoring in computer science and mathematics. I have wide array of interests
                    and I am always looking for a new project. I am looking for full-time roles in multiple areas, including full-stack development and data analytics.</p>
                    <p></p>
